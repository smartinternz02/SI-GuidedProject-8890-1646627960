...
app = Flask(__name__)
model = pickle.load(open('C:\\Users\\thara\\Desktop\\Rainfall_Prediction\\Flask\\rainfall.pkl', 'rb'))
scale = pickle.load(open(r'C:\\Users\\thara\\Desktop\\Rainfall_Prediction\\Flask\\scale.pkl','rb'))
